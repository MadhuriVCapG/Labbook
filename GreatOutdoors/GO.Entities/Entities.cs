...
namespace GO.Entities
{
    ...
    public class SalesUser:User
    {
        ...
        private List<int> salesIDs;

        public int SalesManID { get => salesManID; set => salesManID = value; }
    
        public double SalesManSalary { get => salesManSalary; set => salesManSalary = value; }
        public string SalesManMobile { get => salesManMobile; set => salesManMobile = value; }
